<?php $__env->startSection("title"); ?> Edit Restaurant - Dashboard
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.updateRestaurant')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->name); ?>" type="text" class="form-control form-control-lg" name="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->description); ?>" type="text" class="form-control form-control-lg" name="description"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <img src="<?php echo e(substr(url("/"), 0, strrpos(url("/"), '/'))); ?><?php echo e($restaurant->image); ?>" alt="Image" width="160" style="border-radius: 0.275rem;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->rating); ?>" type="text" class="form-control form-control-lg rating" name="rating"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->delivery_time); ?>" type="text" class="form-control form-control-lg delivery_time" name="delivery_time"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->price_range); ?>" type="text" class="form-control form-control-lg price_range" name="price_range"
                                placeholder="Approx Price for 2 People in <?php echo e(config('settings.currencyFormat')); ?>" required>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->address); ?>" type="text" class="form-control form-control-lg" name="address"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->pincode); ?>" type="text" class="form-control form-control-lg" name="pincode"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->landmark); ?>" type="text" class="form-control form-control-lg" name="landmark"
                    ...
                    <fieldset class="gllpLatlonPicker">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label class="col-form-label">Latitude:</label><input type="text" class="form-control form-control-lg gllpLatitude latitude" value="<?php echo e($restaurant->latitude); ?>" name="latitude" placeholder="Latitude of the Restaurant" required="required">
                            </div>
                            <div class="col-lg-6">
                                <label class="col-form-label">Longitude:</label><input type="text" class="form-control form-control-lg gllpLongitude longitude" value="<?php echo e($restaurant->longitude); ?>" name="longitude" placeholder="Longitude of the Restaurant" required="required">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->restaurant_charges); ?>" type="text" class="form-control form-control-lg restaurant_charges" name="restaurant_charges"
                                placeholder="Restaurant Charge in <?php echo e(config('settings.currencyFormat')); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Certificate/License Code:</label>
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->certificate); ?>" type="text" class="form-control form-control-lg" name="certificate"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                                <input value="true" type="checkbox" class="switchery-primary" <?php if($restaurant->is_pureveg): ?> checked="checked" <?php endif; ?> name="is_pureveg">
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->commission_rate); ?>" type="text" class="form-control form-control-lg commission_rate" name="commission_rate"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <option value="1" class="text-capitalize" <?php if($restaurant->delivery_type == "1"): ?> selected="selected" <?php endif; ?>>Delivery</option>
                            <option value="2" class="text-capitalize" <?php if($restaurant->delivery_type == "2"): ?> selected="selected" <?php endif; ?>>Self Pickup</option>
                            <option value="3" class="text-capitalize" <?php if($restaurant->delivery_type == "3"): ?> selected="selected" <?php endif; ?>>Both Delivery & Self Pickup</option>
                            </select>
                        </div>
                    </div>
                    <?php endif; ?>
                     <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" value="<?php echo e($restaurant->delivery_radius); ?>" class="form-control form-control-lg delivery_radius" name="delivery_radius"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <option value="FIXED" <?php if($restaurant->delivery_charge_type == "FIXED"): ?> selected="selected" <?php endif; ?> class="text-capitalize">Fixed Charge</option>
                            <option value="DYNAMIC" <?php if($restaurant->delivery_charge_type == "DYNAMIC"): ?> selected="selected" <?php endif; ?> class="text-capitalize">Dynamic Charge</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row" id="deliveryCharge">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->delivery_charges); ?>" type="text" class="form-control form-control-lg delivery_charges" name="delivery_charges"
                                placeholder="Delivery Charge in <?php echo e(config('settings.currencyFormat')); ?>">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 row">
                                <div class="col-lg-3">
                                    ...
                                    <input value="<?php echo e($restaurant->base_delivery_charge); ?>" type="text" class="form-control form-control-lg base_delivery_charge" name="base_delivery_charge"
                                    placeholder="In <?php echo e(config('settings.currencyFormat')); ?>">
                                </div>
                                
                                <div class="col-lg-3">
                                    <label class="col-lg-12 col-form-label">Base Delivery Distance:</label>
                                    <input value="<?php echo e($restaurant->base_delivery_distance); ?>" type="text" class="form-control form-control-lg base_delivery_distance" name="base_delivery_distance"
                                    placeholder="In Kilometer (KM)">
                                </div>
                                <div class="col-lg-3">
                                    <label class="col-lg-12 col-form-label">Extra Delivery Charge:</label>
                                    <input value="<?php echo e($restaurant->extra_delivery_charge); ?>" type="text" class="form-control form-control-lg extra_delivery_charge" name="extra_delivery_charge"
                                    placeholder="In <?php echo e(config('settings.currencyFormat')); ?>">
                                </div>
                                
                                <div class="col-lg-3">
                                    <label class="col-lg-12 col-form-label">Extra Delivery Distance:</label>
                                     <input value="<?php echo e($restaurant->extra_delivery_distance); ?>" type="text" class="form-control form-control-lg extra_delivery_distance" name="extra_delivery_distance" placeholder="In Kilometer (KM)">
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <?php $__currentLoopData = $restaurant->restaurant_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="badge badge-flat border-grey-800" style="font-size: 0.9rem;"><?php echo e($resCat->name); ?>
                        ...
                        <option value="<?php echo e($rC->id); ?>" class="text-capitalize"><?php echo e($rC->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                                <input value="true" type="checkbox" class="switchery-primary" <?php if($restaurant->is_featured): ?> checked="checked" <?php endif; ?> name="is_featured">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($restaurant->min_order_price); ?>" type="text" class="form-control form-control-lg min_order_price" name="min_order_price"
                                placeholder="Min Cart Value before discount and tax <?php echo e(config('settings.currencyFormat')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="text-left">
                        <div class="btn-group btn-group-justified" style="width: 225px">
                            ...
                            <a class="btn btn-primary" href="<?php echo e(route('admin.disableRestaurant', $restaurant->id)); ?>">
                            DISABLE
                            <i class="icon-switch2 ml-1"></i>
                            </a>
                            <?php else: ?>
                            <a class="btn btn-danger" href="<?php echo e(route('admin.disableRestaurant', $restaurant->id)); ?>">
                            ENABLE
                            <i class="icon-switch2 ml-1"></i>
                            </a>
                            <?php endif; ?> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer mt-4">
                    <a href="<?php echo e(route('admin.deleteRestaurant', $restaurant->id)); ?>" class="btn btn-primary">Yes</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodomaa\resources\views/admin/editRestaurant.blade.php ENDPATH**/ ?>
