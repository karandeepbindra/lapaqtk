<?php $__env->startSection("title"); ?> Restaurants - Dashboard
    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                <?php if(!Request::is('admin/restaurants/pending-acceptance')): ?>
                <a href="<?php echo e(route('admin.pendingAcceptance')); ?>" class="btn btn-secondary btn-labeled btn-labeled-left mr-2">
                <b><i class="icon-exclamation"></i></b>
                Pending Restaurants
                </a>
                <?php endif; ?>
                <?php if(Request::is('admin/restaurants')): ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo e(substr(url("/"), 0, strrpos(url("/"), '/'))); ?><?php echo e($restaurant->image); ?>" alt="<?php echo e($restaurant->name); ?>" height="80" width="80" style="border-radius: 0.275rem;"></td>
                            ...
                            <?php if($restaurantUser->hasRole("Restaurant Owner")): ?>
                            <td> <a href="<?php echo e(route('admin.get.editUser', $restaurantUser->id)); ?>"><?php echo e($restaurantUser->name); ?></a></td>
                            <?php endif; ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <a href="<?php echo e(route('admin.disableRestaurant', $restaurant->id)); ?>" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Disable Restaurant" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    <?php else: ?>
                                    <a href="<?php echo e(route('admin.disableRestaurant', $restaurant->id)); ?>" class="badge badge-danger badge-icon ml-1" data-popup="tooltip" title="Enable Restaurant" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('admin.getRestaurantItems', $restaurant->id)); ?>" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="View <?php echo e($restaurant->name); ?>'s Items" data-placement="bottom"> <i class="icon-arrow-right5"></i> </a>
                                    <?php if(Request::is('admin/restaurants/pending-acceptance')): ?>
                                    <a href="<?php echo e(route('admin.acceptRestaurant', $restaurant->id)); ?>" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Accept" data-placement="bottom" style="background-color: #FF5722"> <i class="icon-check"></i> </a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodomaa\resources\views/admin/restaurants.blade.php ENDPATH**/ ?>
